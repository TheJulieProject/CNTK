...
namespace CNTK
{
    ...
    /*virtual*/ Dictionary CompositeFunction::Serialize() const
    {
        ...
        SerializationTraversalFunc = [&visitedFunctions, &uniqueInputs, &topoSortedPrimitiveFunctions, &inputUids, &SerializationTraversalFunc](const FunctionPtr& function) {
            ...
            auto blockFunction = dynamic_cast<const BlockFunction*>(function.get());
            if (blockFunction)
                Traverse(blockFunction->Composite()->RootFunction(), SerializationTraversalFunc);
        };

        Traverse(RootFunction(), SerializationTraversalFunc);
